...
class actionWebHookIntegration extends actionBase{
    function actionWebHooksIntegration($id = ''){
    ...
    public function edit_display($line, SugarBean $bean = null, $params = array()){
        ...
        $html .= "<fieldset><legend>".translate('LBL_URL_NOTIFY','AOW_Actions')."<img id='info_img_select_module' src='custom/themes/SuiteP/images/helpInline.gif'  class='image' alt='Info Inline' height='15' width='15' onclick='return SUGAR.util.showHelpTips(this,$urlNotifyLabel);' style='cursor: auto;'></legend>";
        $html .= "<div class='webHookParametersContainer'>";
        ...
        $html .= "<fieldset><legend>".translate('LBL_CONTENT_TYPE','AOW_Actions')."<img id='info_img_select_module' src='custom/themes/SuiteP/images/helpInline.gif'  class='image' alt='Info Inline' height='15' width='15' onclick='return SUGAR.util.showHelpTips(this,$contentTypeLabel);' style='cursor: auto;'></legend>";
        $html .= "<div class='webHookParametersContainer'>";
        ...
        $html .= "<fieldset><legend>".translate('LBL_AUTHORIZATION_TYPE','AOW_Actions')."<img id='info_img_select_module' src='custom/themes/SuiteP/images/helpInline.gif'  class='image' alt='Info Inline' height='15' width='15' onclick='return SUGAR.util.showHelpTips(this,$authorizationTypeLabel);' style='cursor: auto;'></legend>";
        $html .= "<div class='webHookParametersContainer'>";
        ...
        $html .= "<fieldset><legend>".translate('LBL_PARAMETERS','AOW_Actions')."<img id='info_img_select_module' src='custom/themes/SuiteP/images/helpInline.gif'  class='image' alt='Info Inline' height='15' width='15' onclick='return SUGAR.util.showHelpTips(this,$parameterTypeLabel);' style='cursor: auto;'></legend>";
        $html .= "<div class='webHookParametersContainer'>";
        ...
        if(isset($params['action_parameters'])){
            $html .= "<tr rowspan='4' id='parameter_header'><td width='159'></td><td></td><td id='paramtersRow'><p><b>".translate('LBL_PARAMETER_NAME','AOW_Actions')."</b></p></td><td id='parametersValue' style='width:60%;'><p><b>".translate('LBL_PARAMETER_VALUE','AOW_Actions')."</b><img src='custom/themes/SuiteP/images/helpInline.gif'  class='image' alt='Info Inline' height='15' width='15' onclick='return SUGAR.util.showHelpTips(this,$parameterValueInfoLable);'></p></td></tr>";
            $i = 1;
