...
$now = date("Y-m-d");
//Function File
if(file_exists('custom/VIWebhookIntegration/VIWebHookIntegrationFunction.php')) {
    $nowAddWebHookIntegrationFunctionFile = 'VIWebHookIntegrationFunction'.$now.'.'.'php';
    rename("custom/VIWebhookIntegration/VIWebHookIntegrationFunction.php","custom/".$nowAddWebHookIntegrationFunctionFile);
}
