...
if($_REQUEST['method'] == 'validate') {
    VIWebHookIntegrationOutfittersLicense::validate();
} else if($_REQUEST['method'] == 'change') {
    VIWebHookIntegrationOutfittersLicense::change();
} else if($_REQUEST['method'] == 'add') {
    VIWebHookIntegrationOutfittersLicense::add();
    ...
    $validate_license = VIWebHookIntegrationOutfittersLicense::isValid($currentModule,$user_id,true);

    if($validate_license !== true) {

        echo "License did NOT validate.<br/><br/>Reason: ".$validate_license;
        
        $validated = VIWebHookIntegrationOutfittersLicense::doValidate($currentModule);
