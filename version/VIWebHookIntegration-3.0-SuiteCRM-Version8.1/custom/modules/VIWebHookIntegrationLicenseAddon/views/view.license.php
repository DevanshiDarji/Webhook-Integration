...
class ViewLicense extends SugarView{
    ...
    public function display(){
        ...
        require_once('modules/'.$currentModule.'/license/VIWebHookIntegrationOutfittersLicense.php');
        ...
        $key = VIWebHookIntegrationOutfittersLicense::getKey($currentModule);
        if(!empty($key)) {
        ...
        $this->ss->display('modules/VIWebHookIntegrationLicenseAddon/tpls/license.tpl');
    }//end of display
